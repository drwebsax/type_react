...
export default function Contents() {
    ...
    return (
        ...
        <div className="w3-content" style={{maxWidth: '1600px'}}>
            ...
            <img className="w3-image" src="/w3images/jane.jpg" alt="Fashion Blog" width={1600} height={1060} />
            ...
            <div className="w3-col l8 s12">
                ...
                <div className="w3-justify">
                    <img src="/w3images/man_hat.jpg" alt="Men in Hats" style={{width: '100%'}} className="w3-padding-16" />
                ...
                <div className="w3-justify">
                    <img src="/w3images/runway.jpg" alt="Runway" style={{width: '100%'}} className="w3-padding-16" />
            ...
            <div className="w3-col l4">
                ...
                <img src="/w3images/avatar_girl2.jpg" alt="Jane" style={{width: '100%'}} className="w3-grayscale" />
                ...
                <ul className="w3-ul w3-hoverable w3-white">
                    ...
                    <img src="/w3images/avatar_smoke.jpg" alt="Image" className="w3-left w3-margin-right" style={{width: '50px'}} />
                    <span className="w3-large">Denim</span>
                    <br />
                    <span>Sed mattis nunc</span>
                    </li>
                    <li className="w3-padding-16">
                    <img src="/w3images/bandmember.jpg" alt="Image" className="w3-left w3-margin-right" style={{width: '50px'}} />
                    ...
                    <li className="w3-padding-16">
                    <img src="/w3images/avatar_smoke.jpg" alt="Image" className="w3-left w3-margin-right w3-sepia" style={{width: '50px'}} />
